package bilibili_github_not_match.class15;
...
public class Code02_NumberOfIslands {
	...
	public static class UnionFind1<V> {
		public HashMap<V, Node<V>> nodes;  // a对应a圈，b对应b圈
		public HashMap<Node<V>, Node<V>> parents;  // a圈的父是a圈，b圈的父是a圈，c圈的父是b圈，d圈的父是a圈
		public HashMap<Node<V>, Integer> sizeMap;

		public UnionFind1(List<V> values) {  // 构造方法
			nodes = new HashMap<>();
			parents = new HashMap<>();
			sizeMap = new HashMap<>();
			for (V cur : values) {
		...
		public Node<V> findFather(Node<V> cur) {  // 查找顶部代表元素
		...
		public void union(V a, V b) {  // 合并子集合
